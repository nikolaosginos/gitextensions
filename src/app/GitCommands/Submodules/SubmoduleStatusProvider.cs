...
internal sealed class SubmoduleStatusProvider : ISubmoduleStatusProvider
{
    ...
    public SubmoduleStatusProvider(IRepositoryCurrentBranchNameProvider repositoryCurrentBranchNameProvider)
    {
    ...
    private string GetModuleBranch(string path, string noBranchText)
    {
        ...
        string branch = _repositoryCurrentBranchNameProvider.GetCurrentBranchName(path);
