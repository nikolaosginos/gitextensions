...
public partial class UserRepositoriesList : GitExtensionsControl
{
    ...
    private readonly IUserRepositoriesListController _controller = new UserRepositoriesListController(RepositoryHistoryManager.Locals, new InvalidRepositoryRemover(), new RepositoryCurrentBranchNameProvider());
